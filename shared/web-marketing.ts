...
/** The sole contract used by the Worker, API route, persistence, and UI. */
...
/** Converts a normalized result to the exact eight-field Worker API payload. */
export function toGatewayWebMarketingAnalysis(result: WebMarketingResult): Record<string, unknown> {
  return {
    title: result.title,
